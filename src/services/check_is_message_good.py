...
class MessageChecker:
    ...
    def __init__(self, chat: Chat, text: str, is_from_bot: bool, is_from_channel: bool) -> None:
        self._chat = chat
    ...
    def check(self) -> bool:
        ...
        return not (self._is_bad_text() or self._is_from_bot or self._is_from_channel)
